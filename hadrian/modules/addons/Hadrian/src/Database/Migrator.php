...
final class Migrator
{
    ...
    public function rollback(): void
    {
        ...
        \WHMCS\Database\Capsule::schema()->dropIfExists('hadrian_migrations');
    }
    ...
    {
        require_once $file;
        $class = "Hadrian\\Resources\\Migrations\\{$name}";
    ...
    {
        if (\WHMCS\Database\Capsule::schema()->hasTable('hadrian_migrations')) {
            return;
        }
        \WHMCS\Database\Capsule::schema()->create('hadrian_migrations', function ($t) {
            $t->increments('id');
    ...
    {
        return \WHMCS\Database\Capsule::table('hadrian_migrations')
            ->where('name', $name)
            ->exists();
    }
    ...
    {
        \WHMCS\Database\Capsule::table('hadrian_migrations')
