{* Store landing - SocialBee.
   Ported from the v18 SocialBee mockup (Public/Marketing landing).
...
<div class="when-full">
    ...
    <section class="hp-hero" style="padding: 80px 22px 20px; background: transparent;">
        ...
        <div class="hp-cta-row">
            ...
            <span style="font-size: 17px; font-weight: 600; color: var(--color-text-primary);">{$hadrianLang.store.sbFrom} {$_sbFrom}<span style="font-size: 14px; font-weight: 400; color: var(--color-text-tertiary); margin-left: 2px;">/yr</span></span>
        </div>
    </section>

    {* Dashboard mock under hero (decorative) *}
    <section style="padding: 48px 22px 72px; max-width: 1024px; margin: 0 auto;">
        <div style="background: var(--color-surface); border: 1px solid var(--color-border); border-radius: 24px; padding: 14px; box-shadow: 0 24px 60px rgba(0,0,0,0.08);">
            ...
            <div class="hp-mock-panes" style="min-height: 380px;">
                <div style="background: var(--color-surface-secondary); border-radius: 14px; padding: 16px;">
                    <div style="display: flex; flex-direction: column; gap: 6px;">
                        ...
                        <div style="padding: 10px; display: flex; align-items: center; gap: 8px; color: var(--color-text-primary); font-size: 12px;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/></svg>Calendar</div>
                        <div style="padding: 10px; display: flex; align-items: center; gap: 8px; color: var(--color-text-primary); font-size: 12px;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/></svg>Analytics</div>
                        <div style="padding: 10px; display: flex; align-items: center; gap: 8px; color: var(--color-text-primary); font-size: 12px;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>Team</div>
                    </div>
                </div>
                <div style="background: linear-gradient(135deg, #eaf4ff, #dbeafe); border-radius: 14px; padding: 16px;">
                    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 12px;">
                        <div style="font-size: 13px; font-weight: 600; color: var(--color-text-primary);">November 2026</div>
                        <div style="display: flex; gap: 4px;"><span style="padding: 4px 10px; background: var(--color-surface); border-radius: 6px; font-size: 10px;">Week</span><span style="padding: 4px 10px; background: var(--color-accent); color: #fff; border-radius: 6px; font-size: 10px;">Month</span></div>
                    </div>
                    <div style="display: grid; grid-template-columns: repeat(7, 1fr); gap: 6px;">
                        <div style="background: var(--color-surface); border-radius: 6px; padding: 8px; min-height: 44px;"><div style="font-size: 9px; color: var(--color-text-tertiary);">25</div></div>
                        <div style="background: var(--color-surface); border-radius: 6px; padding: 8px; min-height: 44px;"><div style="font-size: 9px; color: var(--color-text-tertiary);">26</div><div style="margin-top: 2px; height: 3px; background: #0071e3; border-radius: 2px;"></div></div>
                        <div style="background: var(--color-surface); border-radius: 6px; padding: 8px; min-height: 44px;"><div style="font-size: 9px; color: var(--color-text-tertiary);">27</div><div style="margin-top: 2px; height: 3px; background: #bf5af2; border-radius: 2px;"></div></div>
                        <div style="background: var(--color-surface); border-radius: 6px; padding: 8px; min-height: 44px;"><div style="font-size: 9px; color: var(--color-text-tertiary);">28</div></div>
                        <div style="background: var(--color-surface); border-radius: 6px; padding: 8px; min-height: 44px;"><div style="font-size: 9px; color: var(--color-text-tertiary);">29</div><div style="margin-top: 2px; height: 3px; background: #30d158; border-radius: 2px;"></div></div>
                        <div style="background: var(--color-surface); border-radius: 6px; padding: 8px; min-height: 44px;"><div style="font-size: 9px; color: var(--color-text-tertiary);">30</div></div>
                        <div style="background: var(--color-surface); border-radius: 6px; padding: 8px; min-height: 44px;"><div style="font-size: 9px; color: var(--color-text-tertiary);">31</div></div>
                        <div style="background: var(--color-surface); border-radius: 6px; padding: 8px; min-height: 44px; border: 2px solid var(--color-accent);"><div style="font-size: 9px; color: var(--color-accent); font-weight: 700;">1</div><div style="margin-top: 2px; height: 3px; background: #0071e3; border-radius: 2px;"></div><div style="margin-top: 2px; height: 3px; background: #ff9f0a; border-radius: 2px;"></div></div>
                        <div style="background: var(--color-surface); border-radius: 6px; padding: 8px; min-height: 44px;"><div style="font-size: 9px; color: var(--color-text-primary);">2</div><div style="margin-top: 2px; height: 3px; background: #bf5af2; border-radius: 2px;"></div></div>
                        <div style="background: var(--color-surface); border-radius: 6px; padding: 8px; min-height: 44px;"><div style="font-size: 9px; color: var(--color-text-primary);">3</div></div>
                        <div style="background: var(--color-surface); border-radius: 6px; padding: 8px; min-height: 44px;"><div style="font-size: 9px; color: var(--color-text-primary);">4</div><div style="margin-top: 2px; height: 3px; background: #30d158; border-radius: 2px;"></div></div>
                        <div style="background: var(--color-surface); border-radius: 6px; padding: 8px; min-height: 44px;"><div style="font-size: 9px; color: var(--color-text-primary);">5</div></div>
                        <div style="background: var(--color-surface); border-radius: 6px; padding: 8px; min-height: 44px;"><div style="font-size: 9px; color: var(--color-text-primary);">6</div><div style="margin-top: 2px; height: 3px; background: #0071e3; border-radius: 2px;"></div></div>
                        <div style="background: var(--color-surface); border-radius: 6px; padding: 8px; min-height: 44px;"><div style="font-size: 9px; color: var(--color-text-primary);">7</div></div>
                    </div>
                </div>
                <div style="background: var(--color-surface-secondary); border-radius: 14px; padding: 16px;">
                    <div style="font-size: 11px; font-weight: 600; color: var(--color-text-primary); margin-bottom: 12px;">Upcoming posts</div>
                    <div style="display: flex; flex-direction: column; gap: 8px;">
                        <div style="background: var(--color-surface); padding: 10px; border-radius: 10px;"><div style="display: flex; align-items: center; gap: 6px; margin-bottom: 4px;"><div style="width: 16px; height: 16px; background: #0866ff; border-radius: 4px;"></div><span style="font-size: 9px; color: var(--color-text-tertiary);">Facebook &middot; 2h</span></div><div style="font-size: 10px; color: var(--color-text-primary);">New product launch &#128640;</div></div>
                        <div style="background: var(--color-surface); padding: 10px; border-radius: 10px;"><div style="display: flex; align-items: center; gap: 6px; margin-bottom: 4px;"><div style="width: 16px; height: 16px; background: linear-gradient(135deg, #833AB4, #FD1D1D); border-radius: 4px;"></div><span style="font-size: 9px; color: var(--color-text-tertiary);">Instagram &middot; 5h</span></div><div style="font-size: 10px; color: var(--color-text-primary);">Behind the scenes &#127916;</div></div>
                        <div style="background: var(--color-surface); padding: 10px; border-radius: 10px;"><div style="display: flex; align-items: center; gap: 6px; margin-bottom: 4px;"><div style="width: 16px; height: 16px; background: #0a66c2; border-radius: 4px;"></div><span style="font-size: 9px; color: var(--color-text-tertiary);">LinkedIn &middot; 1d</span></div><div style="font-size: 10px; color: var(--color-text-primary);">Industry insights &#128202;</div></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="hp-alt-visual">
                <div class="visual-box" style="background: var(--color-surface-secondary); padding: 24px;">
                    <div style="width: 100%; max-width: 300px; background: var(--color-surface); border-radius: 14px; padding: 14px;">
                        <div style="font-size: 11px; font-weight: 600; color: var(--color-text-primary); margin-bottom: 10px;">Compose</div>
                        <div style="padding: 10px; background: var(--color-surface-secondary); border-radius: 10px; min-height: 60px; font-size: 11px; color: var(--color-text-primary);">Launching our new product next week &#128640; Stay tuned for&hellip;</div>
                        <div style="display: flex; gap: 6px; margin-top: 10px;">
                            ...
                            <button style="margin-left: auto; padding: 6px 12px; background: var(--color-accent); color: #fff; border: 0; border-radius: 6px; font-size: 11px; font-weight: 600;">Schedule</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="hp-tab-switcher" style="padding: 72px 22px; max-width: 1024px; margin: 0 auto;">
        ...
        <div style="display: flex; justify-content: center; gap: 4px; margin-bottom: 40px; flex-wrap: wrap;">
            <button style="padding: 10px 20px; background: var(--color-surface); color: var(--color-text-primary); border: 1px solid var(--color-border); border-radius: 999px; font-size: 13px; font-weight: 600; cursor: pointer; box-shadow: 0 2px 6px rgba(0,0,0,0.04);">{$hadrianLang.store.sbTabCreate}</button>
            <button style="padding: 10px 20px; background: transparent; color: var(--color-text-secondary); border: 0; border-radius: 999px; font-size: 13px; font-weight: 500; cursor: pointer;">{$hadrianLang.store.sbTabSchedule}</button>
            <button style="padding: 10px 20px; background: transparent; color: var(--color-text-secondary); border: 0; border-radius: 999px; font-size: 13px; font-weight: 500; cursor: pointer;">{$hadrianLang.store.sbTabEngage}</button>
            <button style="padding: 10px 20px; background: transparent; color: var(--color-text-secondary); border: 0; border-radius: 999px; font-size: 13px; font-weight: 500; cursor: pointer;">{$hadrianLang.store.sbTabCollaborate}</button>
            <button style="padding: 10px 20px; background: transparent; color: var(--color-text-secondary); border: 0; border-radius: 999px; font-size: 13px; font-weight: 500; cursor: pointer;">{$hadrianLang.store.sbTabAnalyze}</button>
        </div>
        <div class="hp-feature-cards">
            <div style="background: var(--color-surface); border-radius: 18px; padding: 28px 22px;"><div style="width: 56px; height: 56px; background: linear-gradient(135deg, #0071e3, #5ac8fa); border-radius: 14px; display: flex; align-items: center; justify-content: center; margin-bottom: 16px;"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg></div><h4 style="font-size: 17px; font-weight: 600; color: var(--color-text-primary); margin: 0 0 8px;">{$hadrianLang.store.sbF1Title}</h4><p style="font-size: 14px; color: var(--color-text-secondary); margin: 0;">{$hadrianLang.store.sbF1Text}</p></div>
            <div style="background: var(--color-surface); border-radius: 18px; padding: 28px 22px;"><div style="width: 56px; height: 56px; background: linear-gradient(135deg, #bf5af2, #c678ff); border-radius: 14px; display: flex; align-items: center; justify-content: center; margin-bottom: 16px;"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2"><path d="M12 2l2 5 5 2-5 2-2 5-2-5-5-2 5-2z"/></svg></div><h4 style="font-size: 17px; font-weight: 600; color: var(--color-text-primary); margin: 0 0 8px;">{$hadrianLang.store.sbF2Title}</h4><p style="font-size: 14px; color: var(--color-text-secondary); margin: 0;">{$hadrianLang.store.sbF2Text}</p></div>
            <div style="background: var(--color-surface); border-radius: 18px; padding: 28px 22px;"><div style="width: 56px; height: 56px; background: linear-gradient(135deg, #ff9f0a, #ffb843); border-radius: 14px; display: flex; align-items: center; justify-content: center; margin-bottom: 16px;"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/></svg></div><h4 style="font-size: 17px; font-weight: 600; color: var(--color-text-primary); margin: 0 0 8px;">{$hadrianLang.store.sbF3Title}</h4><p style="font-size: 14px; color: var(--color-text-secondary); margin: 0;">{$hadrianLang.store.sbF3Text}</p></div>
            <div style="background: var(--color-surface); border-radius: 18px; padding: 28px 22px;"><div style="width: 56px; height: 56px; background: linear-gradient(135deg, #30d158, #5cdb79); border-radius: 14px; display: flex; align-items: center; justify-content: center; margin-bottom: 16px;"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/></svg></div><h4 style="font-size: 17px; font-weight: 600; color: var(--color-text-primary); margin: 0 0 8px;">{$hadrianLang.store.sbF4Title}</h4><p style="font-size: 14px; color: var(--color-text-secondary); margin: 0;">{$hadrianLang.store.sbF4Text}</p></div>
            <div style="background: var(--color-surface); border-radius: 18px; padding: 28px 22px;"><div style="width: 56px; height: 56px; background: linear-gradient(135deg, #5ac8fa, #9ad4ff); border-radius: 14px; display: flex; align-items: center; justify-content: center; margin-bottom: 16px;"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg></div><h4 style="font-size: 17px; font-weight: 600; color: var(--color-text-primary); margin: 0 0 8px;">{$hadrianLang.store.sbF5Title}</h4><p style="font-size: 14px; color: var(--color-text-secondary); margin: 0;">{$hadrianLang.store.sbF5Text}</p></div>
            <div style="background: var(--color-surface); border-radius: 18px; padding: 28px 22px;"><div style="width: 56px; height: 56px; background: linear-gradient(135deg, #ff453a, #ff7a71); border-radius: 14px; display: flex; align-items: center; justify-content: center; margin-bottom: 16px;"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg></div><h4 style="font-size: 17px; font-weight: 600; color: var(--color-text-primary); margin: 0 0 8px;">{$hadrianLang.store.sbF6Title}</h4><p style="font-size: 14px; color: var(--color-text-secondary); margin: 0;">{$hadrianLang.store.sbF6Text}</p></div>
        </div>
