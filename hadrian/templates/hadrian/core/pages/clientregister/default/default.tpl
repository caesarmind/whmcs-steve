        ...
        <form method="post" action="{$smarty.server.PHP_SELF}" class="cr-form" id="frmRegister" role="form" name="orderfrm">
            ...
            <section class="cr-section">
                ...
                {* Generate-password helper — opens the modal below, fills both password
                   fields and copies the result to the clipboard. Mirrors the hadrian_cart
...
{* ── Generate-password modal ──────────────────────────────────────────────
   Same UX as the hadrian_cart checkout modal (pick length → see the password →
...
{* ── Phone country-code chooser ───────────────────────────────────────────
   ...
   the hadrian_cart checkout. Wired with plain DOM (this page has no jQuery).
