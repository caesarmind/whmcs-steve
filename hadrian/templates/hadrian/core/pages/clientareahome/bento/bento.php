    ...
    'supportedOptions' => [
        ...
        'bnt_sections' => [
            ...
            'sections' => [
                ...
                'domains'       => ['label' => 'Domains',           'w' => '1/3', 'list' => true, 'paintable' => true, 'fills' => ['solid', 'tint', 'grad'],
                                    'rowsCompact' => [
                                        'label' => 'Compact rows',
                                        'hint'  => 'Name and status only, with no second line. A dense list you can scan in one pass, for an account with a lot of them or a tile that has to sit in a narrow column.',
                                    ]],
                ...
                'invoices'      => ['label' => 'Billing',           'w' => '1/3', 'list' => true, 'paintable' => true, 'fills' => ['solid', 'tint', 'grad'],
                                    'listToggle' => [
                ...
                'tickets'       => ['label' => 'Support',           'w' => '2/3', 'list' => true, 'paintable' => true, 'fills' => ['solid', 'tint', 'grad'],
                                    'rowsCompact' => [
                                        'label' => 'Compact rows',
                                        'hint'  => 'Name and status only, with no second line. A dense list you can scan in one pass, for an account with a lot of them or a tile that has to sit in a narrow column.',
                                    ]],
                'announcements' => ['label' => 'Announcements',     'w' => '2/3', 'list' => true, 'paintable' => true, 'fills' => ['solid', 'tint', 'grad'],
                                    'rowsCompact' => [
                                        'label' => 'Compact rows',
                                        'hint'  => 'Name and status only, with no second line. A dense list you can scan in one pass, for an account with a lot of them or a tile that has to sit in a narrow column.',
                                    ]],
