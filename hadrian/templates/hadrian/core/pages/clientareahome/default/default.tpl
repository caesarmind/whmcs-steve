{* Hostnodes — Client Home dashboard (Apple-style).
   ...
   Optional from Hadrian hooks ($dashboard):
     activeServices[], recentInvoices[], openTickets[]

   Variant config from $hadrian.pages.clientareahome.config:
...
{* Resolve variant config with hard-coded defaults (no $hadrian dependency) *}
