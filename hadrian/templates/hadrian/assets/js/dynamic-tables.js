/* Hadrian — Unified list-table engine (Lagom-parity Dynamic AJAX Loading).
 *
 ...
 *
 * All user copy comes from window.HadrianTablesLang (English fallback below) and
...
(function () {
    ...
    function lang(key) {
        var L = window.HadrianTablesLang || {};
        var v = L[key];
    ...
    function init() {
        ...
        Array.prototype.forEach.call(tables, function (t) {
            try {
                ...
                if (window.console) { console.error('Hadrian table init failed', err); }
            }
        });
    }
    ...
    window.HadrianTables = { columns: COLUMNS, meta: TYPE_META, esc: esc, pill: pill, kebab: kebab, SVG: SVG };
})();
