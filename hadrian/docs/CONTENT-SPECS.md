...
- **Interactions:** dismiss buttons on notices (JS); body data-attributes drive layout (tiles variant, subnav side, card layout) consumed by core-layout.js. Static otherwise.
