{* store/weebly/index.tpl — Weebly website builder landing. *}
<div class="page-header">
    <h1 class="page-title">{lang key='store.weebly.title'}</h1>
    <p class="page-subtitle">{lang key='store.weebly.subtitle'}</p>
</div>
    ...
    {foreach $packages as $package}
        <div class="store-product-card card">
            ...
            <div class="card-body">
                ...
                <a href="{routePath('cart-add', 'weebly', $package.id)}" class="btn btn-primary btn-full">{lang key='orderNow'}</a>
            </div>
        </div>
    {/foreach}
</div>
