{* =========================================================================
   <head> bundle — loaded by header.tpl. Keeps the tag list short and
   declarative; no layout markup lives here.
   ========================================================================= *}
...
<script src="{assetPath file='whmcs.js'}?v={$versionHash}"></script>
