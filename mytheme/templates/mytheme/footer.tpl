...
{else}
    ...
    <!-- mtfooter: picked={$mtFooterLayoutName|escape} guest={$myTheme.addonSettings.mytheme_active_layout_footer_guest|default:'unset'|escape} client={$myTheme.addonSettings.mytheme_active_layout_footer_client|default:'unset'|escape} legacy={$myTheme.addonSettings.mytheme_active_layout_footer|default:'unset'|escape} attempts={$myTheme.addonSettings.mytheme_layout_save_attempts|default:'0'|escape} last_kind={$myTheme.addonSettings.mytheme_layout_save_last_kind|default:'-'|escape} last_audience={$myTheme.addonSettings.mytheme_layout_save_last_audience|default:'-'|escape} last_value={$myTheme.addonSettings.mytheme_layout_save_last_value|default:'-'|escape} last_accepted={$myTheme.addonSettings.mytheme_layout_save_last_accepted|default:'-'|escape} -->
