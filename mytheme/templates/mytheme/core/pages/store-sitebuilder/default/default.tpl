...
<header class="page-header">
    <p class="page-eyebrow">{$hadrianLang.store.sibEyebrow}</p>
    <h1>{$hadrianLang.store.sibPageTitle}</h1>
    <p class="page-subtitle">{$hadrianLang.store.sibPageSubtitle}</p>
</header>
...
<div class="when-full">
    ...
    <section class="hp-hero">
        ...
        <div style="display: flex; gap: 16px; justify-content: center; margin-top: 48px; flex-wrap: wrap;">
            <div style="width: 200px; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.10); background: #fff;">
                ...
                <div style="padding: 12px 14px;"><div style="font-size: 13px; font-weight: 600; color: #1d1d1f;">Starter</div><div style="font-size: 11px; color: #86868b; margin-top: 2px;">Personal &amp; blog</div></div>
            </div>
            <div style="width: 200px; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.10); background: #fff; transform: translateY(-8px);">
                ...
                <div style="padding: 12px 14px;"><div style="font-size: 13px; font-weight: 600; color: #1d1d1f;">Business</div><div style="font-size: 11px; color: #86868b; margin-top: 2px;">Company &amp; agency</div></div>
            </div>
            <div style="width: 200px; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.10); background: #fff;">
                ...
                <div style="padding: 12px 14px;"><div style="font-size: 13px; font-weight: 600; color: #1d1d1f;">Portfolio</div><div style="font-size: 11px; color: #86868b; margin-top: 2px;">Creative &amp; photography</div></div>
            </div>
        </div>
    </section>
        ...
        <div class="hp-alt-row">
            ...
            <div class="hp-alt-visual">
                <div class="visual-box">
                    <div style="width: 100%;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;"><span style="font-size: 13px; font-weight: 600; color: #1d1d1f;">Template Gallery</span><span style="font-size: 11px; color: #86868b;">150+ available</span></div>
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                            <div style="border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);"><div style="height: 70px; background: linear-gradient(135deg, #f093fb, #f5576c);"></div><div style="padding: 8px 10px; background: #fff;"><div style="font-size: 10px; font-weight: 600; color: #1d1d1f;">Bistro</div><div style="font-size: 9px; color: #86868b;">Restaurant</div></div></div>
                            <div style="border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);"><div style="height: 70px; background: linear-gradient(135deg, #667eea, #764ba2);"></div><div style="padding: 8px 10px; background: #fff;"><div style="font-size: 10px; font-weight: 600; color: #1d1d1f;">Showcase</div><div style="font-size: 9px; color: #86868b;">Portfolio</div></div></div>
                            <div style="border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);"><div style="height: 70px; background: linear-gradient(135deg, #4facfe, #00f2fe);"></div><div style="padding: 8px 10px; background: #fff;"><div style="font-size: 10px; font-weight: 600; color: #1d1d1f;">Storefront</div><div style="font-size: 9px; color: #86868b;">Online Shop</div></div></div>
                            <div style="border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);"><div style="height: 70px; background: linear-gradient(135deg, #0c3483, #a2b6df);"></div><div style="padding: 8px 10px; background: #fff;"><div style="font-size: 10px; font-weight: 600; color: #1d1d1f;">Catalyst</div><div style="font-size: 9px; color: #86868b;">Agency</div></div></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="hp-alt-row">
            ...
            <div class="hp-alt-visual">
                <div class="visual-box" style="background: linear-gradient(180deg, #f0fdf4, #dcfce7);">
                    <div style="width: 100%;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 14px;"><span style="font-size: 13px; font-weight: 600; color: #1d1d1f;">My Store</span><span style="font-size: 11px; color: #30d158; font-weight: 500;">3 products</span></div>
                        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 10px; margin-bottom: 12px;">
                            <div style="border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.06); background: #fff;"><div style="height: 64px; background: linear-gradient(135deg, #ffecd2, #fcb69f);"></div><div style="padding: 8px;"><div style="font-size: 10px; font-weight: 600; color: #1d1d1f;">Canvas Tote</div><div style="font-size: 11px; font-weight: 600; color: #30d158; margin-top: 2px;">$39.00</div></div></div>
                            <div style="border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.06); background: #fff;"><div style="height: 64px; background: linear-gradient(135deg, #a1c4fd, #c2e9fb);"></div><div style="padding: 8px;"><div style="font-size: 10px; font-weight: 600; color: #1d1d1f;">Candle Set</div><div style="font-size: 11px; font-weight: 600; color: #30d158; margin-top: 2px;">$28.00</div></div></div>
                            <div style="border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.06); background: #fff;"><div style="height: 64px; background: linear-gradient(135deg, #d4fc79, #96e6a1);"></div><div style="padding: 8px;"><div style="font-size: 10px; font-weight: 600; color: #1d1d1f;">Art Print</div><div style="font-size: 11px; font-weight: 600; color: #30d158; margin-top: 2px;">$18.00</div></div></div>
                        </div>
                        <div style="background: #fff; border-radius: 10px; padding: 10px 14px; display: flex; justify-content: space-between; align-items: center; box-shadow: 0 1px 4px rgba(0,0,0,0.06);"><div style="font-size: 11px; color: #86868b;">2 items</div><div style="background: #30d158; color: #fff; font-size: 10px; font-weight: 600; padding: 5px 12px; border-radius: 20px;">Checkout $67.00</div></div>
                    </div>
                </div>
            </div>
        </div>
