...
<section class="ph-hero">
    <div class="ph-hero-inner">
        <h1>{$LANG.homepageherotitle|default:'Secure your domain name.'}</h1>
        <p>{$LANG.homepageherosubtitle|default:'Search, register, and transfer — all in one place.'}</p>
...
<section class="ph-section">
    <div class="ph-section-head">
        <div class="eyebrow">{$LANG.productsservices|default:'Products & Services'}</div>
        <h2>{$LANG.homepagesection1title|default:'Browse our products.'}</h2>
    </div>
    <div class="ph-pg-grid">
        <div class="ph-pg-card">
            ...
            <h3>{$LANG.homepagebrowseproductstitle1|default:'WordPress Hosting'}</h3>
            <p>{$LANG.homepagebrowseproductsdesc1|default:'Managed WordPress built for speed, backed by automatic updates.'}</p>
            <a href="{$WEB_ROOT}/cart.php" class="cta">{$LANG.browseproducts|default:'Browse Products'}</a>
        </div>
        <div class="ph-pg-card">
            ...
            <h3>{$LANG.registerdomain|default:'Register a New Domain'}</h3>
            <p>{$LANG.homepagebrowseproductsdesc2|default:'Secure your domain name by registering it today.'}</p>
            <a href="{$WEB_ROOT}/cart.php?a=add&domain=register" class="cta">{$LANG.domainsearch|default:'Domain Search'}</a>
        </div>
        <div class="ph-pg-card">
            ...
            <h3>{$LANG.transferdomain|default:'Transfer Your Domain'}</h3>
            <p>{$LANG.homepagebrowseproductsdesc3|default:'Transfer now to extend your domain by 1 year.'}</p>
            <a href="{$WEB_ROOT}/cart.php?a=add&domain=transfer" class="cta">{$LANG.transferdomain|default:'Transfer Your Domain'}</a>
        </div>
    </div>
</section>
...
<section class="ph-section">
    <div class="ph-section-head">
        <div class="eyebrow">{$LANG.selfservice|default:'Self-service'}</div>
        <h2>{$LANG.homepagesection2title|default:'How can we help today?'}</h2>
    </div>
    <div class="ph-action-grid">
        <a href="{$WEB_ROOT}/announcements.php" class="ph-action">
            ...
            <div class="lbl">{$LANG.announcementstitle|default:'Announcements'}</div>
        </a>
        <a href="{$WEB_ROOT}/serverstatus.php" class="ph-action">
            ...
            <div class="lbl">{$LANG.networkstatus|default:'Network Status'}</div>
        </a>
        <a href="{$WEB_ROOT}/knowledgebase.php" class="ph-action">
            ...
            <div class="lbl">{$LANG.knowledgebasetitle|default:'Knowledgebase'}</div>
        </a>
        <a href="{$WEB_ROOT}/downloads.php" class="ph-action">
            ...
            <div class="lbl">{$LANG.downloadstitle|default:'Downloads'}</div>
        </a>
        <a href="{$WEB_ROOT}/submitticket.php" class="ph-action">
            ...
            <div class="lbl">{$LANG.submitticket|default:'Submit a Ticket'}</div>
        </a>
    </div>
</section>
...
<section class="ph-section" style="padding-bottom: 72px;">
    <div class="ph-section-head">
        ...
        <h2>{$LANG.homepagesection3title|default:'Your account.'}</h2>
    </div>
    <div class="ph-action-grid">
        <a href="{$WEB_ROOT}/clientarea.php" class="ph-action">
            ...
            <div class="lbl">{$LANG.youraccount|default:'Your Account'}</div>
        </a>
        <a href="{$WEB_ROOT}/clientarea.php?action=services" class="ph-action">
            ...
            <div class="lbl">{$LANG.manageservices|default:'Manage Services'}</div>
        </a>
        <a href="{$WEB_ROOT}/clientarea.php?action=domains" class="ph-action">
            ...
            <div class="lbl">{$LANG.managedomains|default:'Manage Domains'}</div>
        </a>
        <a href="{$WEB_ROOT}/supporttickets.php" class="ph-action">
            ...
            <div class="lbl">{$LANG.supportrequests|default:'Support Requests'}</div>
        </a>
        <a href="{$WEB_ROOT}/clientarea.php?action=masspay&all=true" class="ph-action">
            ...
            <div class="lbl">{$LANG.makepayment|default:'Make a Payment'}</div>
        </a>
    </div>
</section>
