...
<header class="page-header">
    <p class="page-eyebrow">{$hadrianLang.store.wblEyebrow}</p>
    <h1>{$hadrianLang.store.wblPageTitle}</h1>
    <p class="page-subtitle">{$hadrianLang.store.wblPageSubtitle}</p>
</header>
...
<div class="when-full">
    ...
    <section class="hp-alternating">
        <div class="hp-alt-row">
            ...
            <div class="hp-alt-visual">
                <div class="visual-box">
                    <div style="width: 100%;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;"><span style="font-size: 13px; font-weight: 600; color: #1d1d1f;">Choose a template</span><span style="font-size: 11px; color: #86868b;">206 available</span></div>
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                            <div style="border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);"><div style="height: 80px; background: linear-gradient(135deg, #667eea, #764ba2);"></div><div style="padding: 8px 10px; background: #fff;"><div style="font-size: 10px; font-weight: 600; color: #1d1d1f;">Starter Portfolio</div><div style="font-size: 9px; color: #86868b;">Creative</div></div></div>
                            <div style="border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);"><div style="height: 80px; background: linear-gradient(135deg, #f093fb, #f5576c);"></div><div style="padding: 8px 10px; background: #fff;"><div style="font-size: 10px; font-weight: 600; color: #1d1d1f;">Bloom Bakery</div><div style="font-size: 9px; color: #86868b;">Restaurant</div></div></div>
                            <div style="border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);"><div style="height: 80px; background: linear-gradient(135deg, #4facfe, #00f2fe);"></div><div style="padding: 8px 10px; background: #fff;"><div style="font-size: 10px; font-weight: 600; color: #1d1d1f;">TechCorp</div><div style="font-size: 9px; color: #86868b;">Business</div></div></div>
                            <div style="border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08);"><div style="height: 80px; background: linear-gradient(135deg, #0c3483, #a2b6df);"></div><div style="padding: 8px 10px; background: #fff;"><div style="font-size: 10px; font-weight: 600; color: #1d1d1f;">ShopFront</div><div style="font-size: 9px; color: #86868b;">Online Store</div></div></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="hp-alt-row reverse">
            ...
            <div class="hp-alt-visual">
                <div class="visual-box" style="background: #f5f5f7;">
                    <div style="width: 100%;">
                        <div style="background: #fff; border-radius: 10px; padding: 8px 12px; margin-bottom: 12px; display: flex; align-items: center; gap: 8px; box-shadow: 0 1px 4px rgba(0,0,0,0.06);">
                            ...
                            <div style="display: flex; gap: 4px; align-items: center;"><div style="width: 16px; height: 16px; background: #0071e3; border-radius: 4px;"></div><div style="width: 16px; height: 16px; background: #1d1d1f; border-radius: 4px;"></div><div style="width: 16px; height: 16px; background: #f5f5f7; border: 1px solid #e8e8ed; border-radius: 4px;"></div></div>
                        </div>
                        <div style="background: #fff; border-radius: 10px; padding: 16px; box-shadow: 0 1px 4px rgba(0,0,0,0.06);">
                            <div style="border: 2px dashed #0071e3; border-radius: 8px; padding: 14px; margin-bottom: 10px; position: relative;"><div style="position: absolute; top: -8px; left: 12px; background: #0071e3; color: #fff; font-size: 8px; padding: 2px 6px; border-radius: 4px; font-weight: 600;">HERO</div><div style="height: 40px; background: linear-gradient(135deg, #667eea, #764ba2); border-radius: 6px;"></div></div>
                            <div style="border: 1px solid #e8e8ed; border-radius: 8px; padding: 10px; margin-bottom: 10px;"><div style="width: 80px; height: 3px; background: #1d1d1f; border-radius: 2px; margin-bottom: 6px;"></div><div style="width: 100%; height: 3px; background: #e8e8ed; border-radius: 2px; margin-bottom: 4px;"></div><div style="width: 70%; height: 3px; background: #e8e8ed; border-radius: 2px;"></div></div>
                            <div style="border: 1px solid #e8e8ed; border-radius: 8px; padding: 8px; display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 6px;"><div style="height: 32px; background: #f0f0f5; border-radius: 4px;"></div><div style="height: 32px; background: #f0f0f5; border-radius: 4px;"></div><div style="height: 32px; background: #f0f0f5; border-radius: 4px;"></div></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="hp-alt-row">
            ...
            <div class="hp-alt-visual">
                <div class="visual-box">
                    <div style="width: 100%;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;"><span style="font-size: 13px; font-weight: 600; color: #1d1d1f;">Your Store</span><span style="font-size: 11px; color: #30d158; font-weight: 500;">3 products live</span></div>
                        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 10px;">
                            <div style="border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.06); background: #fff;"><div style="height: 70px; background: linear-gradient(135deg, #ffecd2, #fcb69f);"></div><div style="padding: 8px;"><div style="font-size: 10px; font-weight: 600; color: #1d1d1f;">Leather Bag</div><div style="font-size: 11px; font-weight: 600; color: var(--color-accent); margin-top: 2px;">$89.00</div></div></div>
                            <div style="border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.06); background: #fff;"><div style="height: 70px; background: linear-gradient(135deg, #a1c4fd, #c2e9fb);"></div><div style="padding: 8px;"><div style="font-size: 10px; font-weight: 600; color: #1d1d1f;">Candle Set</div><div style="font-size: 11px; font-weight: 600; color: var(--color-accent); margin-top: 2px;">$34.00</div></div></div>
                            <div style="border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.06); background: #fff;"><div style="height: 70px; background: linear-gradient(135deg, #d4fc79, #96e6a1);"></div><div style="padding: 8px;"><div style="font-size: 10px; font-weight: 600; color: #1d1d1f;">Art Print</div><div style="font-size: 11px; font-weight: 600; color: var(--color-accent); margin-top: 2px;">$24.00</div></div></div>
                        </div>
                        <div style="margin-top: 12px; background: #fff; border-radius: 10px; padding: 10px 14px; display: flex; justify-content: space-between; align-items: center; box-shadow: 0 1px 4px rgba(0,0,0,0.06);"><div style="font-size: 11px; color: #86868b;">3 items in cart</div><div style="background: #30d158; color: #fff; font-size: 10px; font-weight: 600; padding: 5px 12px; border-radius: 20px;">Checkout $147.00</div></div>
                    </div>
                </div>
            </div>
        </div>
