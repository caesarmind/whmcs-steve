...
<section class="mt-section">
    ...
    <div style="display:flex; gap:8px; flex-wrap:wrap;">
        <a class="mt-btn mt-btn-primary mt-btn-sm" href="?module=MyTheme&action=sitemap&sub=generate">Generate now</a>
        <a class="mt-btn mt-btn-secondary mt-btn-sm" href="?module=MyTheme&action=sitemap&sub=preview">Preview XML</a>
    </div>
</section>
