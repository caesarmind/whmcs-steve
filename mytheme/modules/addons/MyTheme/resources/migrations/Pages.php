 ...
 * mytheme_settings `<tpl>_page_options_<page>` / `<tpl>_page_variant_<page>`
 ...
 * mytheme_settings will do" note in Initial.php: a queryable registry is what
...
final class Pages
{
    public function up(): void
    {
        ...
        if ($schema->hasTable('mytheme_pages')) {
            return;
        }
        $schema->create('mytheme_pages', function ($t) {
            $t->increments('id');
