 ...
 *     productid select name (id #inputProductId{$num}).
 *   - .product wrapper + #product{$num} id so any product-targeting
 *     CSS / JS still applies.
 *   - .row-eq-height grid pattern intact.
 *}
