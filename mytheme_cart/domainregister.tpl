 ...
 *   #frmDomainChecker (a=checkDomain hidden), #message (advanced) /
 *   #inputDomain (basic), #btnCheckAvailability, #DomainSearchResults,
 *   #primarySuggestionHeading, #primaryExactHeading, #searchDomainInfo,
 *   #primaryLookupSearching, #primaryLookupResult, #idnLanguageSelector,
 *   #spotlightTlds, #suggestionsLoader, #domainSuggestions,
 *   #moreSuggestions, #noMoreSuggestions, #captchaContainer,
 *   #inputCaptchaImage, #inputCaptcha
 *
...
<div id="order-standard_cart">
    ...
    <div class="row">
        ...
        <div class="cart-body">
            ...
            {* ─── Lookup result + spotlights + suggestions ─── *}
            ...
            <div class="domain-pricing">
                ...
                <div class="tld-filters">
                    {foreach $categoriesWithCounts as $category => $count}
                        <a href="#" data-category="{$category}" class="badge badge-secondary">
