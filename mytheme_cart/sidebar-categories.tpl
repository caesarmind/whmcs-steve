...
<aside>
    ...
    {else}
        ...
        <div class="card subnav-card">
            <div class="subnav-heading">{$LANG.categories|default:'Categories'}</div>
            {if $productgroups}
        ...
        <div class="card subnav-card subnav-card--gap">
            ...
            <a href="{$WEB_ROOT}/clientarea.php?action=domains" class="subnav-item">
                ...
                <span class="subnav-item-label">{$LANG.cartrenewdomains|default:'Renew Domains'}</span>
            </a>
            <a href="{$WEB_ROOT}/cart.php?a=add&domain=register" class="subnav-item">
                ...
                <span class="subnav-item-label">{$LANG.cartregisterdomain|default:'Register a New Domain'}</span>
            </a>
            <a href="{$WEB_ROOT}/cart.php?a=add&domain=transfer" class="subnav-item">
                ...
                <span class="subnav-item-label">{$LANG.carttransferdomain|default:'Transfer in a Domain'}</span>
            </a>
            ...
            <a href="{$WEB_ROOT}/cart.php?a=view" class="subnav-item">
                ...
                <span class="subnav-item-label">{$LANG.viewcart|default:'View Cart'}</span>
