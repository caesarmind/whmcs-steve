{*
 * mytheme_cart/domaintransfer.tpl - Apple-shell rebuild.
 *
 ...
 *           |- sidebar-categories.tpl (Categories + Actions, mytheme_cart's)
 *           `- main column
...
/* Full / empty toggle -- scoped so mytheme's global .when-full hide
...
<div id="order-standard_cart">
    ...
    <div class="st-split">
        ...
        {* ── Sidebar: Categories + Actions (mytheme_cart's, not standard_cart's) ── *}
