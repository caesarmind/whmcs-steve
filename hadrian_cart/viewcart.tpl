 ...
 *   - Old .when-full / .when-empty class names -- hadrian's global CSS
                            ...
                            <div class="ct-product-head">
                                ...
                                <div class="ct-product-meta">
                                    ...
                                    {if $product.domain}
                                        ...
                                        {if $hadrian.addonSettings.op_hide_hostname_checkout|default:false}
                                            {assign var=opHostVc value=$hadrian.addonSettings.op_hide_hostname|default:'off'}
                                            {if $opHostVc == 'all'}
                                                {assign var=mtHideDomain value=true}
                                            {elseif $opHostVc == 'selected'}
                                                {assign var=hostGroupsVc value=$hadrian.addonSettings.op_hide_hostname_groups|default:[]}
