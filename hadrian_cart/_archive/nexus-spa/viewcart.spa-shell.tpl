{*
 * hadrian_cart/viewcart.tpl -- nexus_cart SPA shell
 *
 ...
 *      path so this works without changing hadrian_cart's parent
...
{else}
    ...
    {* The Apple --primary / --bg / --text variable overrides for the
       ...
       rendered with the full hadrian layout cookies present.
