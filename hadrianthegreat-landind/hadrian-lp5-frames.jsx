...
function paintFrame(doc, s) {
  ...
  // A design with no portal chrome can still have a coloured field of its own --
  // the full-bleed sign-ins colour their panel under data-panel, on the same
  // light | tinted | brand | gradient vocabulary the sidebar tones use. Only
